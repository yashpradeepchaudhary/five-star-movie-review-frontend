...
const SearchResults = ({
  ...
  }, [focusedIndex]); //Whenever the focusedIndex will change then that entire code will fired.

  if (!visible) return null;
  return (
    <div className="absolute z-50 left-0 right-0 top-10 bg-white dark:bg-secondary shadow-md p-2 max-h-64 space-y-2 mt-1 overflow-auto custom-scroll-bar">
